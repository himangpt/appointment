            ...
            <table class="table table-striped custom-table" id="example">
                ...
                <tbody>
                      ...
                      $query=mysqli_query($con,"SELECT * from prescription_records AS pre 
                        ...
                        ON pre.appoinmentid=app.appoinmentid where pre.doctorid='$_SESSION[doctorid]' and pre.patientid='$_GET[patientid]'");
                      $sn=0;
     ...
     <table class="table table-striped custom-table" id="example">
                ...
                <tbody>
                      ...
                      $query=mysqli_query($con,"SELECT * from appoinment AS app 
                        ...
                        ON app.departmentid=dep.departmentid where app.doctorid='$_SESSION[doctorid]' and app.patientid='$_GET[patientid]'");
                       $sn=0;
                      while($row=mysqli_fetch_array($query)){
                      extract($row);              
                          ?>
