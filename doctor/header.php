                                    ...
                                    <a href="activities.html">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="noti-details"><span class="noti-title">John Doe</span> added new task <span class=o"noti-title">Patient appointment booking</span></p>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="profile.php"><i class="fa fa-user-md"></i> <span>Doctors</span></a>
                        </li>
                        <li>
                            <a href="patients.php"><i class="fa fa-wheelchair"></i> <span>Patients</span></a>
                        </li>
                        <li>
                            <a href="appointments.php"><i class="fa fa-calendar"></i> <span>Pending Appointments</span></a>
                        </li>
                        <li>
                            <a href="confirm-appointments.php"><i class="fa fa-calendar"></i> <span>Confirm Appointments</span></a>
                        </li>
                        <li>
