...
$query = "SELECT * FROM doctor WHERE doctorid = '$doctorid' and status='Active'";
...
<?php include_once 'header.php'; ?>
        <div class="page-wrapper">
            <div class="content">
            	...
            	<form method="get" action=""><strong>Date -</strong><input type="text" name="date" class="datetimepicker" value="<?php echo $_GET['date']; ?>" ><input type="submit" class="btn btn-primary" name="submit" value="Submit"></form></div></div>
                <div class="row">
                	 <?php
          $sql = "SELECT * FROM appoinment WHERE appstatus='Approved' and doctorid='$_SESSION[doctorid]'";
	if(isset($_GET['date']))
	{
		$sql = $sql . " AND appoinmentdate ='$_GET[date]'";
	}
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
							...
							<div class="dash-widget-info text-right">
								<h3><?=$count;?></h3>
								<span class="widget-title1">Appoinments <i class="fa fa-check" aria-hidden="true"></i></span>
							</div>
                        </div>
                    </div>
                <?php
          $sql = "SELECT * FROM appoinment AS app
          INNER JOIN patient AS pat
          ON app.patientid=pat.patientid 
          WHERE pat.status='Active' and doctorid='$_SESSION[doctorid]'";
	if(isset($_GET['date']))
	{
		$sql = $sql . " AND appoinmentdate ='$_GET[date]'";
	}
        ...
        ?>
                    ...
                    <?php
          $sql = "SELECT * FROM doctor WHERE status='Active' and doctorid='$_SESSION[doctorid]'";
          $run = mysqli_query($con,$sql);
          $count = mysqli_num_rows($run);
        ?>
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info text-right">
                                <h3><?=$count;?></h3>
                                <span class="widget-title3">Doctor<i class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                    <?php
          $sql = "SELECT * FROM appoinment WHERE appstatus='Pending' and doctorid='$_SESSION[doctorid]'";
	if(isset($_GET['date']))
	{
		$sql = $sql . " AND appoinmentdate ='$_GET[date]'";
	}
        ...
        ?>
				...
				<div class="row">
					<div class="col-12 col-md-6 col-lg-8 col-xl-8">
                      ...
                      $query=mysqli_query($con,"SELECT * from appoinment AS app 
                        ...
                        ON app.departmentid=dep.departmentid WHERE app.status='Active'and app.doctorid='$_SESSION[doctorid]' LIMIT 5");
                      $sn=0;
                          ...
                          ?>
											<tr>
												<td style="min-width: 200px;">
													...
													<h2><a href=""><?=$patientname;?><span><?=$address;?></span></a></h2>
												</td>                 
												<td>
                        ...
                        <div class="card member-panel">
                            ...
                            <div class="card-body">
                                <ul class="contact-list">
                                	 <?php
                                        $query=mysqli_query($con,"SELECT * from doctor where status='Active' and doctorid='$_SESSION[doctorid]'");
                                        while($row=mysqli_fetch_array($query)){
                                        extract($row);              
                                                    ?>
                                    <li>
                                        <div class="contact-cont">
                                            ...
                                            <div class="contact-info">
                                                <span class="contact-name text-ellipsis"><?=$doctorname;?></span>
                                                <span class="contact-date"><?=$edegree;?></span>
                                            </div>
                                        </div>
                                    </li>
                                <?php } ?>
                            ...
                            <div class="card-footer text-center bg-white">
                                <a href="profile.php" class="text-muted">View all Doctors</a>
                            </div>
                        </div>
                    </div>
				</div>
          ...
          INNER JOIN patient AS pat
          ON app.patientid=pat.patientid 
          WHERE pat.status='Active' and doctorid='$_SESSION[doctorid]' LIMIT 5");
           while($row=mysqli_fetch_array($query)){
                                        extract($row);              
                                                    ?>
											<tr>
												...
												<td><?=$email;?></td>
												<td><?=$mobile;?></td>
												<td><button class="btn btn-primary btn-primary-one float-right"><?=$symptom;?></button></td>
											</tr>
											<?php } ?>
											<tr>
												<td>
