				...
				<div class="row">
                   ...
                   <!--  <th>Appointment Print</th>  -->
                      ...
                      $query=mysqli_query($con,"SELECT * from appoinment AS app 
                        ...
                        ON app.departmentid=dep.departmentid where app.appstatus='Confirm' and app.doctorid='$_SESSION[doctorid]' ORDER BY app.appoinmentid DESC");
                      $sn=0;
                      ...
                      ?></td>
                                        ...
                                        <?php } ?>
                                        <td>
                                          <a href="patient-report.php?patientid=<?=$patientid;?>&appid=<?=$appoinmentid;?>">View</a>
                                        </td>
										 <!-- <td class="text-right">
