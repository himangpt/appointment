...
<div class="page-wrapper">
            <div class="content">
				...
				<div class="row doctor-grid">
					<?php
                      $query=mysqli_query($con,"SELECT * from doctor AS doc  JOIN department AS dep ON doc.departmentid = dep.departmentid ");
                    ...
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            <div class="doctor-img">
                                <a class="avatar" href="profile.php?doctor_id=<?=$doctorid;?>"><img alt="" src="../admin/assets/img/<?php echo $image; ?>"></a>
                            </div>
                            <div class="dropdown profile-action">
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="edit-doctor.php?doctor_id=<?=$doctorid;?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                    <a class="dropdown-item" id="mybutton" href="#" data-toggle="modal" data-target="#delete_doctor" data-id="<?=$doctorid; ?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                </div>
                            </div>
                            <h4 class="doctor-name text-ellipsis"><a href="profile.php?doctor_id=<?=$doctorid;?>"><?= $doctorname;?></a></h4>
                            <div class="doc-prof"><?= $departmentname; ?></div>
