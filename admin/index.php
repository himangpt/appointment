...
$query = "SELECT * FROM admin WHERE adminid = '$adminid' and status='Active'";
...
<?php include_once 'header.php'; ?>
        <div class="page-wrapper">
            ...
            <div class="col-md-12 text-right">
                ...
                <div class="row">
                	 <?php
          $sql = "SELECT * FROM appoinment WHERE appstatus='Approved'";
	if(isset($_GET['date']))
	{
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
							...
							<div class="dash-widget-info text-right">
								<h3><?=$count;?></h3>
								<span class="widget-title1">Appointm<i class="fa fa-check" aria-hidden="true"></i></span>
							</div>
                        </div>
                    </div>
                     <?php
	...
	if(isset($_GET['date']))
	{
        ...
        ?>
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                     ...
                     <?php
          $sql = "SELECT * FROM appoinment WHERE appstatus='Pending'";
	if(isset($_GET['date']))
	{
		$sql = $sql . " AND appoinmentdate ='$_GET[date]'";
	}
				...
				<div class="row">
					<div class="col-12 col-md-6 col-lg-8 col-xl-8">
                      ...
                      $query=mysqli_query($con,"SELECT * from appoinment AS app 
                        ...
                        ON app.departmentid=dep.departmentid WHERE app.status='Active' LIMIT 5");
                      $sn=0;
                        ...
                        <div class="card member-panel">
                            ...
                            <div class="card-body">
                                <ul class="contact-list">
                                	 <?php
                                        $query=mysqli_query($con,"SELECT * from doctor where status='Active'");
                                        while($row=mysqli_fetch_array($query)){
                                        extract($row);              
                                                    ?>
                                    <li>
							...
							<div class="card-block">
								<div class="table-responsive">
									<table class="table mb-0 new-patient-table">
										<tbody>
											 <?php
                                        $query=mysqli_query($con,"SELECT * from patient where status='Active' LIMIT 5");
                                        while($row=mysqli_fetch_array($query)){
                                        extract($row);              
                                                    ?>
											<tr>
